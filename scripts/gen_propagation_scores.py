...
from args import CovArgs, HDArgs
...
n_tests = 4
alpha = [0.8, 1] * 2
sheet_names = ['Kent_10h-VIC_10h', 'Kent_10h-VIC_10h',
                'Kent_24h-VIC_24h', 'Kent_24h-VIC_24h'] # ['Suppl. Table 4A'] * len(alpha)
prior_set_conditions = [args.condition_function_name] * n_tests # ['huntington_DDA_significant'] * len(alpha)
propagation_input_type_list = ['Score'] * n_tests
