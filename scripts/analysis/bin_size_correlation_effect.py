...
bin_centrality_cor, bin_score_cor = [], []
...
font_size = 24
font_size_2 = 14
x_positions = np.arange(1,len(bin_size_list)+1)
...
axs[0].set_xticklabels(labels=bin_size_list)
axs[0].grid()
...
axs[1].set_xticklabels(labels=bin_size_list)
axs[1].grid()
